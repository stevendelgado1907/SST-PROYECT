-- Función para insertar relación trabajador-arl-eps

CREATE OR REPLACE FUNCTION fn_insertar_trabajador_arl_eps(
...
BEGIN
    ...
    INSERT INTO tab_trabajadores_arl_eps (
        id_trabajador_arl_eps, 
        id_trabajador, 
        id_arl, 
        id_eps, 
        fecha_afiliacion, 
    ...
    RETURNING id_trabajador_arl_eps INTO v_id_insertado;
    
    RETURN v_id_insertado;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION 'Error al insertar relación trabajador-arl-eps: %', SQLERRM;
END;
$$ LANGUAGE plpgsql;